#pragma once
class StructureModel_CLASS RWallDowelRebarTemplate
{
public:
	RWallDowelRebarTemplate();
	~RWallDowelRebarTemplate();

	void DataInit();
	void CopyFromMe(RWallDowelRebarTemplate* pRebarTemplate);
	...
	BOOL GetBotAddBarIntegratedPlaceSet();
	void SetBotAddBarIntegratedPlaceSet(BOOL value);
	BOOL GetDowelAdjustRatioSet();
	void SetDowelAdjustRatioSet(BOOL value);
	int GetDowelAdjustRatio();
	void SetDowelAdjustRatio(int value);
	BOOL GetSupportBarUserSteelGradeS();
	void SetSupportBarUserSteelGradeS(BOOL value);
	long GetBotAddBarIntegratedPlaceLengthConditionType();
	void SetBotAddBarIntegratedPlaceLengthConditionType(long value);
	long GetBotAddBarIntegratedPlaceLengthCondition();
	void SetBotAddBarIntegratedPlaceLengthCondition(long value);
...
private:
	...
	BOOL m_bBotAddBarIntegratedPlaceSet;
	long m_nBotAddBarIntegratedPlaceLengthConditionType;
	long m_nBotAddBarIntegratedPlaceLengthCondition;

	BOOL dowelAdjustRatioSet;
	int dowelAdjustRatio;
