...
#### 2.3.1 부재 모델 (MSCompoM)
- **MSCompoM**: 부재의 형상 및 속성 정보를 담는 모델 클래스
- **MSLineMemberM**: 선형 부재 모델
- **MSCustomM**: 사용자 정의 부재 모델
- **MSCustomBeamM**: 사용자 정의 보 모델
- **MSCustomColumnM**: 사용자 정의 기둥 모델
- **MSCustomWallColumnM**: 사용자 정의 벽기둥 모델

#### 2.3.2 부재 지오메트리 (MSCompoG)
- **MSCompoG**: 부재의 지오메트리 정보를 담는 클래스
- **MSBeamG**: 보 지오메트리
- **MSColumnG**: 기둥 지오메트리  
- **MSWallMemberG**: 벽체 지오메트리
- **MSSlabG**: 슬래브 지오메트리
- **MSIsoFootG**: 독립기초 지오메트리
- **MSStairG**: 계단 지오메트리
- **MSRampG**: 램프 지오메트리
- **MSPitG**: 피트 지오메트리
...
### 5.2 나유크 시스템
- **NayukTemplate**: 나유크 템플릿
- **NayukTemplateManager**: 나유크 템플릿 관리
- **NayukFormworkSetting**: 나유크 거푸집 설정
- **NayukRebarSetting**: 나유크 철근 설정
- **NayukConcreteSetting**: 나유크 콘크리트 설정
...
BaseRebarTemplate* template = building->GetRebarTemplate(RT_COLUMN);
```
